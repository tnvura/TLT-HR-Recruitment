...
import InterviewerOfferManagement from "./pages/InterviewerOfferManagement";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/candidates/:id"
            element={
              <ProtectedRoute allowedRoles={['hr_admin', 'hr_staff', 'hr_manager', 'interviewer']}>
                <CandidateDetail />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={['interviewer', 'hr_admin', 'hr_manager']}>
                <InterviewerDashboard />
              </ProtectedRoute>
            }
          />
          <Route
            path="/interviewer/offers"
            element={
              <ProtectedRoute allowedRoles={['interviewer', 'hr_admin']}>
                <InterviewerOfferManagement />
              </ProtectedRoute>
            }
          />
          <Route
