        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              {interviewFeedback?.current_salary && (
                <div>
                  <Label className="text-xs text-muted-foreground">Current Salary</Label>
                  <p className="text-sm font-medium">
                    {interviewFeedback.current_salary?.toLocaleString()} THB
                  </p>
                </div>
              )}
              {interviewFeedback?.expected_salary && (
                <div>
                  <Label className="text-xs text-muted-foreground">Expected Salary</Label>
                  <p className="text-sm font-medium">
                    {interviewFeedback.expected_salary?.toLocaleString()} THB
                  </p>
                </div>
              )}
              {interviewFeedback?.current_position && (
                <div>
                  <Label className="text-xs text-muted-foreground">Current Position</Label>
                  <p className="text-sm font-medium">{interviewFeedback.current_position}</p>
                </div>
              )}
            </div>
