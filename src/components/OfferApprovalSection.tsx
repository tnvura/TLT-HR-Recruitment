...
interface OfferApprovalSectionProps {
  ...
  userRole: "hr_manager" | "interviewer";
...
export function OfferApprovalSection({
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      if (isHRManager) {
        ...
        toast({
          title: "Approved",
          description: "Job offer approved successfully. Interviewer has been notified.",
        });
        ...
        await (supabase as any)
          ...
          .insert({
            ...
            notes: "Job offer acknowledged by interviewer",
          });

        toast({
          title: "Acknowledged",
          description: "Job offer acknowledged successfully. Candidate status updated to Offer Sent.",
        });
      }
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      // Update candidate status back to to_offer
      const { error: statusError } = await supabase
        .from("candidates")
        .update({
          status: "to_offer",
      ...
      toast({
        title: "Rejected",
        description: "Job offer has been rejected. Candidate status updated.",
      });
